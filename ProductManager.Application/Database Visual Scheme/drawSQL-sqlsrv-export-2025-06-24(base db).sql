...
CREATE TABLE "OptionalParameters"(
    ...
    "OptionalParameterName" BIGINT NOT NULL
);
ALTER TABLE
...
CREATE TABLE "PricelistOptionalParameters"(
    ...
    "PricelistPurchaseID" BIGINT NULL
);
ALTER TABLE
...
ALTER TABLE
    "PricelistOptionalParameters" ADD CONSTRAINT "pricelistoptionalparameters_pricelistpurchaseid_foreign" FOREIGN KEY("PricelistPurchaseID") REFERENCES "PricelistProductPurchases"("PurchaseID");
ALTER TABLE
